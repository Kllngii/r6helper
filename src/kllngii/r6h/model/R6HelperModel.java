...
//		Angreifer
		...
		_o.add(new Operator(ANGREIFER, "Rekrut Blau", L85A2, M590A1, AR33, G36C, R4C, _556XI, M1014,F2, _417, SG_CQB, AK12, BAL_SCHILD, AUGA2, _552C, Arrays.asList(SMG11, P2_26)));
		_o.add(new Operator(ANGREIFER, "Rekrut Gelb", L85A2, M590A1, AR33, G36C, R4C, _556XI, M1014,F2, _417, SG_CQB, AK12, BAL_SCHILD, AUGA2, _552C, Arrays.asList(SMG11, P2_26)));
		_o.add(new Operator(ANGREIFER, "Rekrut Grün", L85A2, M590A1, AR33, G36C, R4C, _556XI, M1014,F2, _417, SG_CQB, AK12, BAL_SCHILD, AUGA2, _552C, Arrays.asList(SMG11, P2_26)));
		_o.add(new Operator(ANGREIFER, "Rekrut Rot", L85A2, M590A1, AR33, G36C, R4C, _556XI, M1014,F2, _417, SG_CQB, AK12, BAL_SCHILD, AUGA2, _552C, Arrays.asList(SMG11, P2_26)));
		_o.add(new Operator(ANGREIFER, "Rekrut Orange", L85A2, M590A1, AR33, G36C, R4C, _556XI, M1014,F2, _417, SG_CQB, AK12, BAL_SCHILD, AUGA2, _552C, Arrays.asList(SMG11, P2_26)));
